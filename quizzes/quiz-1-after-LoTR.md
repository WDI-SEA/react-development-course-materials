...
- At the end of the quiz, there is a link to [this review guide](https://git.generalassemb.ly/education-product/react-review-guides/blob/master/unit-1-react-review-guide.md). Students will see this in the quiz slides; you don't need to share the link.
